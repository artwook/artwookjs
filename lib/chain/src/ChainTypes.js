...
ChainTypes.operations = {
    ...
    asset_manager_create_operation: 49,
    asset_manager_update_operation: 50,
    asset_manager_force_buyback_asset_operation: 51,
    asset_manager_force_buyback_holder_operation: 52,
    asset_issue_by_symbol_operation: 53,
    asset_claim_pool_by_symbol_operation: 54,
    opc_create_operation: 55,
    opc_delete_operation: 56,
    opc_call_operation: 57,
    opc_receipt_create_operation: 58
};
